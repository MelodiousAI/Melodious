...
from src.path_utils import PROJECT_ROOT, resolve_existing_asset_path

NODES_JSON_PATH = resolve_existing_asset_path("data", "processed", "muscima_nodes.json")
EDGES_JSON_PATH = resolve_existing_asset_path("data", "processed", "muscima_edges.json")
IMAGE_ROOT = resolve_existing_asset_path("data", "cvc-muscima", "CVCMUSCIMA_WI", "PNG_GT_Gray")
