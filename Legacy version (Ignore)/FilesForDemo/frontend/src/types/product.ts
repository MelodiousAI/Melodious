...
export type ProductUploadDetection = {
  class_id: number
  class_name: string
  confidence: number
  bbox: {
...
export type ProductUploadClassCount = {
  class_name: string
  count: number
}

export type ProductImageClassificationResult = {
  file_name: string
  image_width: number
  image_height: number
  ...
  class_counts: ProductUploadClassCount[]
  detections: ProductUploadDetection[]
  notices: string[]
}
