...
3. **The product/demo surface is runnable.** On 2026-04-27 the copied `demo/` package passed backend tests, frontend tests/build, API smoke routes (`/health`, `/product/config`, `/product/transcribe`), MUSCIMA reference evaluation, and a 5-page training-export smoke run.
