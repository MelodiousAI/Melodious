...
- Fur Elise local demo evidence after tiled thin-symbol inference and GNN rhythm integration is stored under `runs/demo/fur_elise_tiled_gnn_rhythm_nodots_20260605/`. Compared with the staff-fixed full-page run, it keeps 9 staff systems and 256 note events, keeps dotted notes at 3, and improves stem-confirmed notes from 0 to 171. This is a local demo transcription result, not an official detector metric claim.
