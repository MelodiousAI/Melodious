...
under `runs/demo/image_note_extraction_v3/`. After the light-staff detector
fix, it detected 9 staff systems, wrote 319 note events, inferred 37 dotted
notes, produced a 2878-byte MIDI file, and produced MusicXML with 319 notes and
37 `<dot/>` tags. It also had 0 stem-confirmed notes, so rhythm quality is still
