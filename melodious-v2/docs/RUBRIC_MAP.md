...
- Metric improvement evidence: `docs/METRIC_IMPROVEMENT.md`, `configs/detection_136class_eval_resolution_sweep.yaml`, and `runs/detection/detection_136class_yolov8m_eval_img1248_v1/metrics.json`.
...
- Results/logs/ablations: docs/EXPERIMENTS.md from `runs/**/metrics.json`; current runs include `detection_15class_repro_sample_v1`, `detection_136class_yolov8s_smoke_v1`, `detection_136class_yolov8m_v1`, `detection_136class_yolov8m_eval_img1248_v1`, `graph_legacy_gnn_muscima_val_v1`, and `e2e_muscima_holdout_xml_fixture_v1`.
