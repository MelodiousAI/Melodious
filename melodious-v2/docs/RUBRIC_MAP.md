...
- Results/logs/ablations: docs/EXPERIMENTS.md from `runs/**/metrics.json`; current runs include `detection_15class_repro_sample_v1`, `detection_136class_yolov8s_smoke_v1`, `detection_136class_yolov8m_v1`, and `graph_legacy_gnn_muscima_val_v1`.
