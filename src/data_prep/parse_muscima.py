...
def parse_args(argv=None):
    """Parse command-line arguments before doing any dataset work."""
    parser = argparse.ArgumentParser(
        description="Parse MUSCIMA++ XML annotations into data/processed JSON files."
    )
    parser.add_argument(
        "--limit",
        type=int,
        default=None,
        help="Optional max number of XML files to parse for a quick smoke run.",
    )
